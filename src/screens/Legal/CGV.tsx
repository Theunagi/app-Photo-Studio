  ...
  return (
    <div className="legal-page">
      <div className="legal-container">
        ...
        <h2>1. Objet</h2>
        <p>Les présentes Conditions Générales de Vente (CGV) régissent les relations contractuelles entre <span className="placeholder">[Dénomination sociale]</span> (ci-après « FrameFlow ») et toute personne physique ou morale souscrivant à un abonnement au service FrameFlow (ci-après « le Client »).</p>

        <h2>2. Description du service</h2>
        <p>FrameFlow est un service en ligne (SaaS) de photographie produit assistée par intelligence artificielle. Le service comprend :</p>
        <ul>
        ...
        <p>FrameFlow se réserve le droit de modifier ses tarifs. Toute modification sera communiquée au Client avec un préavis de 30 jours. Le nouveau tarif s'appliquera à la prochaine période de facturation.</p>
        ...
        <p>Conformément aux articles L215-1 à L215-5 du Code de la consommation (loi Chatel), FrameFlow informe le Client entre 3 mois et 1 mois avant la date de renouvellement de la possibilité de ne pas reconduire son abonnement.</p>
        ...
        <p>Pour exercer ce droit, le Client peut envoyer sa demande par email à : contact@frameflow.design ou utiliser le formulaire de rétractation ci-dessous.</p>
        ...
        <p style={{ background: '#F5F4F0', padding: '16px', borderRadius: '8px', fontSize: '13px' }}>
          ...
          Je vous notifie par la présente ma rétractation du contrat portant sur l'abonnement au service FrameFlow.<br/><br/>
        ...
        <p>FrameFlow s'engage à fournir le service avec diligence. Toutefois, FrameFlow ne saurait être tenu responsable :</p>
        <ul>
        ...
        <p>FrameFlow ne conserve pas les images traitées au-delà de la durée nécessaire à la fourniture du service, sauf accord explicite du Client.</p>

        <h2>11. Protection des données</h2>
        <p>FrameFlow traite les données personnelles du Client conformément au RGPD. Pour plus d'informations, consultez notre Politique de Confidentialité.</p>
