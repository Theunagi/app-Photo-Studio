  ...
  return (
    <div className="legal-page">
      <div className="legal-container">
        ...
        <h2>1. Objet</h2>
        <p>Les pr&eacute;sentes Conditions G&eacute;n&eacute;rales d'Utilisation (CGU) d&eacute;finissent les modalit&eacute;s d'acc&egrave;s et d'utilisation du service Photo Studio. En cr&eacute;ant un compte, l'Utilisateur accepte sans r&eacute;serve les pr&eacute;sentes CGU.</p>
        ...
        <ul>
          ...
          <li>Informer Photo Studio imm&eacute;diatement en cas d'utilisation non autoris&eacute;e de son compte</li>
        </ul>
        ...
        <ul>
          ...
          <li>Tenter d'acc&eacute;der aux syst&egrave;mes informatiques de Photo Studio de mani&egrave;re non autoris&eacute;e</li>
        ...
        <p>L'Utilisateur conserve l'int&eacute;gralit&eacute; de ses droits de propri&eacute;t&eacute; intellectuelle sur les images qu'il t&eacute;l&eacute;verse. En utilisant le service, l'Utilisateur accorde &agrave; Photo Studio une licence limit&eacute;e, non exclusive et temporaire de traiter ces images dans le seul but de fournir le service.</p>
        ...
        <h3>Service Photo Studio</h3>
        <p>Le logiciel, les algorithmes, l'interface et le design de Photo Studio sont la propri&eacute;t&eacute; exclusive de <span className="placeholder">[D&eacute;nomination sociale]</span>. L'abonnement conf&egrave;re &agrave; l'Utilisateur un droit d'utilisation personnel, non cessible et non exclusif.</p>

        <h2>5. Disponibilit&eacute; du service</h2>
        <p>Photo Studio s'efforce d'assurer une disponibilit&eacute; continue du service. Toutefois, le service peut &ecirc;tre temporairement interrompu pour des raisons de maintenance, de mise &agrave; jour ou de force majeure. Photo Studio informera les Utilisateurs dans la mesure du possible en cas d'interruption programm&eacute;e.</p>

        <h2>6. Limitation de responsabilit&eacute;</h2>
        <p>Photo Studio ne garantit pas que les r&eacute;sultats g&eacute;n&eacute;r&eacute;s par l'intelligence artificielle seront adapt&eacute;s aux besoins sp&eacute;cifiques de l'Utilisateur. Le service est fourni &laquo; en l'&eacute;tat &raquo;.</p>
        <p>En aucun cas, Photo Studio ne pourra &ecirc;tre tenu responsable des dommages indirects (perte de chiffre d'affaires, perte de donn&eacute;es, atteinte &agrave; l'image) r&eacute;sultant de l'utilisation du service.</p>

        <h2>7. Suspension et r&eacute;siliation</h2>
        <p>Photo Studio se r&eacute;serve le droit de suspendre ou de r&eacute;silier le compte d'un Utilisateur en cas de violation des pr&eacute;sentes CGU, notamment en cas de :</p>
        <ul>
          <li>Utilisation frauduleuse ou abusive du service</li>
          <li>T&eacute;l&eacute;versement de contenus illicites</li>
          <li>Atteinte aux syst&egrave;mes informatiques de Photo Studio</li>
        </ul>
        <p>En cas de suspension, l'Utilisateur sera inform&eacute; par email et pourra pr&eacute;senter ses observations.</p>

        <h2>8. Modification des CGU</h2>
        <p>Photo Studio se r&eacute;serve le droit de modifier les pr&eacute;sentes CGU. Les Utilisateurs seront inform&eacute;s de toute modification substantielle par email ou notification dans l'application, avec un pr&eacute;avis de 15 jours. La poursuite de l'utilisation du service apr&egrave;s ce d&eacute;lai vaut acceptation des nouvelles CGU.</p>
