    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <p>
          ...
          Contact : <span className="placeholder">[email DPO/contact &agrave; compl&eacute;ter]</span>
        </p>
        ...
        <p>Pour exercer ces droits, contactez-nous &agrave; : <span className="placeholder">[email DPO &agrave; compl&eacute;ter]</span></p>
        ...
        <p>Photo Studio met en &oelig;uvre des mesures techniques et organisationnelles appropri&eacute;es pour prot&eacute;ger vos donn&eacute;es : chiffrement HTTPS, contr&ocirc;le d'acc&egrave;s, sauvegardes r&eacute;guli&egrave;res, h&eacute;bergement s&eacute;curis&eacute;.</p>
        <p>En cas de violation de donn&eacute;es, Photo Studio s'engage &agrave; notifier la CNIL dans les 72 heures et &agrave; informer les personnes concern&eacute;es si la violation est susceptible d'engendrer un risque &eacute;lev&eacute;.</p>

        <h2>8. Utilisation des images</h2>
        <p>Les images t&eacute;l&eacute;vers&eacute;es par le Client sont trait&eacute;es uniquement dans le cadre de la fourniture du service. Photo Studio ne les utilise pas &agrave; d'autres fins (notamment pas pour l'entra&icirc;nement de mod&egrave;les d'IA) sauf consentement explicite du Client.</p>
      </div>
    </div>
  );
};
